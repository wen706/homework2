...
num_list_even_squares=get_even_squares(num_list)
num_list_odd_cubes=get_odd_cubes(num_list)
num_list_sliced_list=get_sliced_list(num_list)

print(",".join(format_numbers(num_list_even_squares)))
print(",".join(format_numbers(num_list_odd_cubes)))
print(",".join(format_numbers(num_list_sliced_list)))